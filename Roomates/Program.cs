            ...
            while (runProgram)
            {
                ...
                switch (selection)
                {
                    ...
                    case ("Delete a room"):
                        ...
                        {
                            Console.WriteLine($"{r.Id}. {r.Name}, Maximum Occupancy {r.MaxOccupancy}");
                        }
                        Console.Write("Select a room to delete: ");
                        int roomDeleteChoice = int.Parse(Console.ReadLine());
                        roomRepo.Delete(roomDeleteChoice);
                        break;
                    ...
                    case ("Search for roommate"):
                        ...
                        Console.WriteLine($"{roommate.Id} - {roommate.FirstName} {roommate.LastName} lives in the {roommate.Room.Name}");
                        Console.Write("Press any key to continue");
                        Console.ReadKey();
                        break;
                    ...
                    case ("Assign chore to roommate"):
                        ...
                        Console.WriteLine($"Chore #{choreChoice} assigned to Roommate #{roommateChoice}");
                        Console.Write("Press any key to continue");
                        Console.ReadKey();
                        break;
                    case ("Exit"):
